...
const TableDummy = () => {
  ...
  return (
    <div >
     <div style={{ display: "flex", marginTop: "0.5%" ,backgroundColor:" ",padding:"0.5%"}}>
        <Button variant="disabled" style={{ backgroundColor: "#d3d3d3", width: "15%", marginRight: "1%", marginLeft: "1%" }}>ASSIGN POOL</Button>
        <TextField id="filled-basic" label="Filled" variant="filled"  onChange={(e) => { setSearch(e.target.value.toLowerCase()) }} style={{width:"20%"}}/>
      </div>
    <div style={{margin:"3%",backgroundColor:"#fff",borderRadius:"10px",padding:"1%"}}>
     
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <div style={{ marginRight: "1%" }}><CloudDownloadIcon /></div>
        <div style={{ marginRight: "1%" }}> <LocalPrintshopIcon /></div>
        <div style={{ marginRight: "1%" }} ><ViewColumnIcon /></div>
